#ifndef YMSAT1_SATREASON_H
#define YMSAT1_SATREASON_H
...
/// ここではそれに倣い，SatClause へのポインタと SatLiteral を排他的に
/// 表現するクラスを作った．
//////////////////////////////////////////////////////////////////////
class SatReason
{
...
// @param[in] lit リテラル
inline
SatReason::SatReason(SatLiteral lit)
{
...
{
  return SatLiteral::index2literal(mBody >> 1);
}
