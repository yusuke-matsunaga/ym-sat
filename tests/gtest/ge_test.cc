...
TEST_P(GeTest, add_ge_1_1)
{
  check(1, 1);
}

TEST_P(GeTest, add_ge_2_1)
{
  check(2, 1);
}

TEST_P(GeTest, add_ge_1_2)
{
  check(1, 2);
}

TEST_P(GeTest, add_ge_2_2)
{
  check(2, 2);
}

TEST_P(GeTest, add_ge_5_5)
{
  check(5, 5);
}

TEST_P(GeTest, add_ge_7_7)
{
  check(7, 7);
}

TEST_P(GeTest, add_ge_7_4)
{
  check(7, 4);
}

TEST_P(GeTest, add_ge_4_7)
{
  check(7, 4);
}

TEST_P(GeTest, add_ge_10_10)
{
  check(10, 10);
}

TEST_P(GeTest, add_ge_10_5)
{
  check(10, 5);
}

TEST_P(GeTest, add_ge_5_10)
{
  check(10, 5);
}
