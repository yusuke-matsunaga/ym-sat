...
TEST_P(GtConstTest, add_gt_1_1)
{
  check(1, 1);
}

TEST_P(GtConstTest, add_gt_2_3)
{
  check(2, 3);
}

TEST_P(GtConstTest, add_gt_5_6)
{
  check(5, 6);
}

TEST_P(GtConstTest, add_gt_7_10)
{
  check(7, 10);
}

TEST_P(GtConstTest, add_gt_7_13)
{
  check(7, 13);
}

TEST_P(GtConstTest, add_gt_10_496)
{
  check(10, 496);
}

TEST_P(GtConstTest, add_gt_15_0)
{
  check(10, 0);
}
